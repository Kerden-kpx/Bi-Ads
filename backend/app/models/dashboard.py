...
注意：
- ImpressionData 已移除，现在直接从原始数据表（facebook_ads, google_ads）获取印象数据
- PurchaseData 已移除，现在直接从原始数据表（facebook_ads, google_ads）获取购买/转化数据
...
class FacebookAdsRaw(Base):
    ...
    createtime = Column(String(255), primary_key=True, comment='日期')
