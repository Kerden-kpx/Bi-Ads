<template>
  <div class="card">
    ...
    <div v-else class="card-content">
      <div class="table-wrapper">
        ...
        >
          ...
          >
            <template #default="scope">
              {{ scope.row.isTotal ? scope.row.purchasesPrevious : scope.row.purchasesPrevious }}
            </template>
          </el-table-column>
    ...
    <el-dialog
      ...
      title="Ad Sets Performance Overview"
      width="95%"
      top="2vh"
...
export default {
  name: 'Facebook_AdSets_Performance_Card',
  components: {
    FullScreen,
    Top,
    Bottom
